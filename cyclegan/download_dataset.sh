...
# NOTE: This is a code copied from CycleGAN pytorch implementation repository.
# link: https://github.com/junyanz/pytorch-CycleGAN-and-pix2pix/blob/master/datasets/download_cyclegan_dataset.sh
